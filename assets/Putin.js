...
if (age<13)
{
    confirm ("Dette spillet er ikke for småbarn som deg, men hvis du er en ekte våghals, kan du spille spillet sammen med en voksen.");
} else {
    confirm ("Flott, du er gammel nok til å dra på eventyr alene.");
}

confirm ("Du går tur i skogen, da selveste Vladimir Putin plutselig kommer ridende på en bjørn mot deg");
